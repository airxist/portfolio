...
export const workExperiences = [
  {
    ...
    endDate: "Present",
    description:
      "Software developers design, create, and maintain software applications. They work on various platforms, including web, mobile, and desktop. Their tasks involve coding, testing, debugging, and collaborating with other team members to create functional and user-friendly software products. Software development requires strong problem-solving skills, proficiency in multiple programming languages, and the ability to adapt to new technologies.",
  },
  {
    ...
    endDate: "Present",
    description:
      "Cybersecurity analysts protect organizations' digital assets from cyber threats. They monitor networks for security breaches, investigate incidents, and implement measures to secure data. Their responsibilities include developing security protocols, conducting risk assessments, and staying updated on the latest cyber threats and vulnerabilities. This career requires strong analytical skills, knowledge of security tools and practices, and the ability to respond swiftly to security incidents.",
  },
  {
    ...
    endDate: "Present",
    description:
      "Renewable energy engineers design and implement systems that generate energy from renewable sources such as solar, wind, and hydroelectric power. They work on projects to improve energy efficiency and sustainability. Their tasks include conducting site assessments, designing energy systems, and collaborating with other engineers and stakeholders to bring renewable energy projects to fruition. This career requires a deep understanding of renewable energy technologies, environmental science, and project management skills.",
  },
];
